...
function PhotoGallery() {
  ...
  const activeCategory =
    selectedCategory !== ALL_TAGS && !topTags.includes(selectedCategory) && !otherTags.includes(selectedCategory)
      ? ALL_TAGS
      : selectedCategory;
  ...
  const renderMasonryItem = useCallback(
    ({ data, width }: { data: MasonryItemType; width: number }) => {
  ...
  return (
    <section id="photo-gallery" className="photo-gallery-section min-h-screen pt-24 pb-20 px-4 lg:px-8">
      ...
      <div className="afilmory-hero-container">
        ...
        >
          Capturing beautiful moments in life, documenting daily
          <br />
          warmth and emotions through my lens.
        </motion.p>
