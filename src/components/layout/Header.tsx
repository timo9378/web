...
import { MegaMenuRoot, MegaMenu as MegaMenuItem } from '@/components/mega-menu/MegaMenu';
import HomeMenuContent from '@/components/mega-menu/HomeMenu';
import BlogMenuContent from '@/components/mega-menu/BlogMenu';
import MoreMenuContent from '@/components/mega-menu/MoreMenu';
...
function Header(_props: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      <nav className="site-nav" aria-label={t('nav.menu')} onMouseMove={handleMouseMove}>
